<div id="back">
<img id="p" src="img/logo.jpg"> <h1 id="quote">"Cooking is like LOVE.It should be entered into with abandon or not at all."</h1>
</div>
<nav class="navbar navbar-default" >
  <!-- <div class="container"> -->
    ...
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="index.php"><b>Cafeteria Management</b></a> -->
    </div>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="overflow:auto;">
      <ul class="nav navbar-nav">
        ...
        <li style="margin-left:50rem;"><a href="conn.php?logout='1'">Logout</a></li>
      </ul>
    <!-- </div>/.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
